     ...
     <table class="table table-bordered " width="100%" id="MyTable">
      ...
      <tbody>
        ...
        <td><div class="btn-group">
          <a href="acthps/H-pengguna.php?id=<?php echo $r['id_pelanggan']; ?>" class="btn btn-danger">Hapus</a>
          <a href="data-pengguna.php?id=<?php echo $r['id_pelanggan']; ?>" class="btn btn-primary">Data Penggunaan</a>
        </div></td>
        </tr>
        <?php 
        $no++;
