  ...
  <section class="container-fluid"> 
    <div class="">
      <div class="text-center">
        ...
        <p><i><small>Pendaftaran pegawai baru yang sudah meng koatak admin untuk mengelola pembayaran dari aplikasi ini.</small></i></p>
        <hr>
      </div>
...
<script type="text/javascript">
  ...
  function validate(field ,query ){
    ...
    document.getElementById(field).innerHTML = "Error Occurred. <a href='tambah-pegawai.php'>Reload Or Try Again</a> the page.";
    }
    }
