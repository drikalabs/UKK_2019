              ...
              $user =$data->fetch_assoc();
               ?>
                ...
                <div class="btn-group">
                  ...
                  <a href="tambah-penggunaan.php?id=<?php echo $user['id_pelanggan']; ?>" class="btn btn-info"> <span class="fa fa-plus"> Tambah Penggunaan</span></a>
                </div>
            </div>
        </div>
    </div>
     ...
     <table class="table table-bordered " width="100%" id="MyTable">
      ...
      <tbody>
        ...
        <td><div class="btn-group">
          <?php if ($r['event']==0): ?>
          <a href="acthps/H-data-peng.php?id=<?php echo $r['id_penggunaan']; ?>&idpeng=<?php echo $userid; ?>" class="btn btn-danger">Hapus</a>
          
          <a href="actedit/E-dapeng.php?id=<?php echo $r['id_penggunaan']; ?>&idpeng=<?php echo $userid; ?>" class="btn btn-info">Ubah Data</a>
          
          <a href="tambah-tagihan.php?id=<?php echo $r['id_penggunaan']; ?>&idpeng=<?php echo $userid; ?>" class="btn btn-primary">Proses Tagihan</a>

        <?php elseif ($r['event']==1):?>
          
          <a href="actedit/E-dapeng.php?id=<?php echo $r['id_penggunaan']; ?>&idpeng=<?php echo $userid; ?>" class="btn btn-info" disabled>Ubah Data</a>
          
          <a href="tambah-tagihan.php?id=<?php echo $r['id_penggunaan']; ?>&idpeng=<?php echo $userid; ?>" class="btn btn-success" disabled>Tagihan <span class="fa fa-check"></span></a>
          <?php endif ?>
        </div></td>
        </tr>
        <?php 
